 ...
 let [users,setUsers]=useState([])
  useEffect(()=>{
    const getNewUsers=async()=>{
      try {
        const res=await axios.get('/api/Users/NewUsers')
        // res.data
        setUsers(res.data)
      } catch {
